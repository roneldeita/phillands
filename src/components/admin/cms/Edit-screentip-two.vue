<template>
  <el-card class="box-card">
    <div slot="header" class="clearfix">
      <h5 style="float:left; color:#999999;margin-top:5px">Unit Details</h5>
    ...
    <screentip-two v-if="!editTip"></screentip-two>
...
export default {
  ...
  methods:{
    loadContent:function(){
      axios.get(baseUrl()+'/content/content/publish_property_2')
      .then(response =>{
